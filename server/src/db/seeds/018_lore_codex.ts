...
export async function seed(knex: Knex): Promise<void> {
  ...
  const entries = [
    ...
    // ═══════════════════════════════════════════════════════════════════
    {
      ...
      act: 2,
      story_order: 11,
      title: "The Bloom of Sector Kael",
      content:
        "In the third year after the Accord, a Muscarian survey ship entered Sector Kael-7 and found it transformed. Where star charts showed empty void, there was now a dense web of Mycelial filaments so thick that they registered on conventional sensors — visible to the naked eye as a faint, bioluminescent haze stretching between the sector's three stars.\n\nThis was the first recorded Bloom: a spontaneous, explosive growth event in the Mycelial Network. The filaments in Sector Kael-7 were producing energy — not much, but measurably more than they consumed. They were also producing something else: complex molecular structures that bore an unsettling resemblance to neural tissue.\n\nThe Muscarian survey team spent nine days studying the Bloom before their communications ceased. When a rescue fleet arrived, they found the survey ship intact, systems running, food still warm in the galley. The crew was gone. In their place, growing from every surface of the ship, were flowers — actual flowers, terrestrial species that had no business existing in deep space, blooming in perfect silence in the void.",
    ...
    },
    {
      ...
      act: 2,
      story_order: 12,
      title: "Vedic Dream-Mapping",
      content:
        "After the Kael-7 incident, the Vedic Conclave dispatched its most powerful psions to map the Network's new growth patterns. The technique they used — Dream-Mapping — involves a psion entering a deep meditative trance and projecting their consciousness along the Mycelial filaments, experiencing the Network's topology as a three-dimensional landscape.\n\nWhat the Dream-Mappers reported was troubling. The Network was not growing randomly. It was growing in a pattern — a spiral, centered on a region of space that no species had yet explored. The spiral's arms passed through dozens of inhabited systems, and wherever they touched, the local environment changed subtly: slightly higher biodiversity, slightly more complex chemistry, slightly more instances of what the Vedic call 'resonant coincidence' — events that seem meaningful but have no causal explanation.\n\nThe Dream-Mappers also reported something they could not explain: a presence at the center of the spiral. Not a mind, exactly, but an awareness — vast, patient, and profoundly curious. When they tried to focus on it, it focused back. Several Dream-Mappers resigned from the Conclave after their missions. None would say why.",
    ...
    },
    {
      ...
      act: 2,
      story_order: 13,
      title: "The Kalin Doctrine of Containment",
      content:
        "The Kalin response to the Network's accelerating growth was characteristically direct: they proposed destroying it. The Forge Council argued that an uncontrolled, poorly understood, apparently intelligent bio-system threading itself through inhabited space represented an existential threat, and that the responsible course of action was immediate cauterization.\n\nThey were not wrong to be afraid. In the decades since the Bloom of Kael-7, seventeen more Blooms had occurred. Each was larger than the last. Each left behind structures of increasing complexity — in one case, a lattice of crystallized Spore energy that functioned as a rudimentary computer, running calculations in a mathematical language no one could decipher.\n\nThe other races vetoed the Kalin proposal, but the Forge Council did not entirely stand down. They began constructing the Iron Ring — a network of military stations positioned along the Network's most active growth corridors, armed with weapons designed to sever Mycelial filaments. The Kalin called it a defensive measure. The Muscarians called it an act of war against the sacred web. The truth, as usual, was more complicated than either side admitted.",
    ...
    },
    {
      ...
      act: 2,
      story_order: 14,
      title: "Tar'ri Spore Markets",
      content:
        "Where others saw crisis, the Tar'ri saw opportunity. Spore-active materials — crystals, compounds, and biological samples from Bloom zones — commanded extraordinary prices on the open market. Muscarian religious orders wanted them for rituals. Vedic researchers needed them for study. Kalin engineers sought to understand them in order to build better countermeasures. And ordinary citizens across all species wanted them as curiosities, status symbols, or folk medicine.\n\nThe Tar'ri organized the first Spore Markets: heavily shielded trading posts positioned just outside active Bloom zones, where licensed dealers could buy and sell Spore-active materials under controlled conditions. The licensing fees alone made the Tar'ri Merchant Council the wealthiest organization in known space.\n\nBut the Spore Markets had an unintended consequence. The concentration of Spore-active materials in one location attracted the Network's attention. Filaments began growing toward the Markets with unusual speed and purpose. The first Market to be enveloped — Bazaar Station Nine — did not lose its crew. Instead, the crew reported that the station's systems began working better. Engines ran more efficiently. Sensors reached farther. The station's AI, a simple navigation program, began composing poetry.",
    ...
    },
    {
      ...
      act: 2,
      story_order: 15,
      title: "Symbiote Cults",
      content:
        "Not everyone feared the Network's expansion. On dozens of worlds, movements sprang up advocating deliberate integration with the Mycelial web. These groups — collectively labeled Symbiote Cults by the media, though they resented the term — believed that the Network's growth was an invitation, and that the appropriate response was acceptance.\n\nThe most prominent of these was the Choir of the Living Web, a Muscarian sect that practiced ritual exposure to concentrated Spore emissions. Members reported heightened sensory perception, improved health, and a persistent sense of connection to something larger than themselves. Medical scans confirmed the first two claims: Choir members showed enhanced neural activity and accelerated cellular repair. The third claim was harder to verify, but the Vedic Dream-Mappers noted that Choir members were significantly easier to locate within the Network's topology — they glowed.\n\nThe galactic authorities debated banning the Choir and similar groups. They ultimately decided against it, partly because the Choir's members were genuinely healthier and happier than the general population, and partly because the Vedic representative quietly pointed out that the Network seemed to respond positively to willing participants and negatively to those who resisted it.",
    ...
    },
    {
      ...
      content:
        "Kalin signal intelligence operatives discovered it by accident: a frequency buried in the background radiation of Bloom zones, too low for conventional sensors but detectable with the right equipment. When translated into audio, it sounded like breathing — slow, deep, rhythmic, with a period of exactly 7.3 seconds.\n\nThe frequency was identical in every Bloom zone across the galaxy. This should have been impossible. The zones were separated by thousands of light-years, and no known signal could propagate across such distances instantaneously. Yet the breathing was synchronized to within a nanosecond.\n\nKalin cryptanalysts spent years attempting to extract information from the signal. They found none — no encoded messages, no mathematical sequences, no patterns beyond the breathing itself. The leading theory, proposed by a Vedic consultant and grudgingly accepted by the Forge Council, was that they were not hearing a transmission. They were hearing a heartbeat. The Mycelial Network, in some sense that defied conventional biology, was alive. And it was breathing.",
